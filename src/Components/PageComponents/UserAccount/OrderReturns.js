            ...
            <div className="border-1 border-borderColor px-4 py-4 rounded-lg">
                    ...
                    <table className="w-full table-fixed">
                        ...
                        <tbody>
                            ...
                            <tr className="border-b h-12">
                                ...
                                <td>
                                    <p className="font-DMSans text-sm1">Returned</p>
                                </td>
                                <td>
                ...
                <div className="responsive-order-list md:hidden">
                    <div className="mb-4">
                        ...
                        <p className="font-Poppins font-medium text-sm mb-1">Status:  <span className="font-DMSans text-sm1 font-normal inline-block ml-2">Returned</span></p>
