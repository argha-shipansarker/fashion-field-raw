...
import {
    ...
    updateSelectedBrand,
} from "../ReduxStore/StoreFilteringSystem/StoreFilter";

// import BrandPageSidebar from '../Components/PageComponents/BrandPage/BrandPageSidebar'
import StorePageSidebar from "../Components/PageComponents/StorePage/StorePageSidebar";
...
const StoreProducts = () => {
    ...
    const { mainSelectedAttributeArray, selectedBrand } = useSelector(
        (state) => state.storeFilter
    );
    ...
    useEffect(() => {
        ...
        axios
            ...
            .then((response) => {
                ...
                setStoreName(response.data.productStore.name);
                setLoading(true);
            })
            .catch((errors) => {
        ...
        <div className="container mx-auto pl-4 pr-4 md:pr-7 mt-20 md:mt-0">
            <div className="container mx-auto mt-8">
                <ol className="list-reset flex text-sm font-medium font-Poppins">
                    ...
                    <li className="text-mutedText">{storeName}</li>
                </ol>
            </div>
            <div className="grid grid-cols-4 gap-x-7.5 mt-5">
                <div className="hidden md:block">
                    <StorePageSidebar categories={categories} />
                </div>
